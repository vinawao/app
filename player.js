...
const CONFIG = {
  ...
  //  'https://bit.ly/IndihomeTV', 
   // 'https://project.denstv.workers.dev/logo/3_combined_playlist.m3u', 
  ...
  //  'https://dplay.denstv.workers.dev/m3u/MIX.txt', 
    ...
    async initialize() {
        ...
        try {
            ...
            ui.configure({
                ...
                overflowMenuButtons: ['captions', 'language_audio', 'language', 'playback_rate'],
...
function renderGrid() {
  ...
  filtered.forEach(c => {
    ...
    d.innerHTML = `
      <img class="rotate" src="${c.logo || ''}" loading="lazy" onerror="this.replaceWith(Object.assign(document.createElement('div'), { innerText: 'No Logo', style: 'display:flex;align-items:center;justify-content:center;width:100%;height: 65%;background:#333;color:#fff;' }))" />
...
console.log('DPLAY Player v2.0 loaded');
